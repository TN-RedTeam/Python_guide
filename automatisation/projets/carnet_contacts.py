...
Exemples de lancement (recopie une ligne dans ton terminal) :
   ...
   python3 python/automatisation/projets/carnet_contacts.py ajouter --nom Bob --tel 0700000000 --email bob@mail.fr
   ...
   python3 python/automatisation/projets/carnet_contacts.py supprimer --nom Bob
