...
```bash
python3 python/automatisation/02_fichiers_dossiers/lire_ecrire.py
python3 python/automatisation/02_fichiers_dossiers/csv_json.py
python3 python/automatisation/02_fichiers_dossiers/ranger_dossier.py
```
